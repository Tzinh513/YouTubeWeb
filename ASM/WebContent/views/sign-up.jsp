...
<title>X-Video</title>
  ...
  <link href="<c:url value ='/assets/css/nucleo-svg.css" rel="stylesheet '/>" />
  <!-- CSS Files -->
  <link id="pagestyle" href="<c:url value ='/assets/css/soft-ui-dashboard.css?v=1.0.3" rel="stylesheet'/>" />
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0" id="navigation">
        <ul class="navbar-nav navbar-nav-hover mx-auto">
          <li class="nav-item dropdown dropdown-hover mx-2">
            <a role="button" class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center " id="dropdownMenuPages" data-bs-toggle="dropdown" aria-expanded="false">
              Pages
              <img src=" <%=request.getContextPath()%>/assets/img/down-arrow-dark.svg  " alt="down-arrow" class="arrow ms-1 d-lg-block d-none">
              <img src="<%=request.getContextPath()%>/assets/img/down-arrow-dark.svg" alt="down-arrow" class="arrow ms-1 d-lg-none d-block">
            </a>
          ...
          <li class="nav-item dropdown dropdown-hover mx-2">
            ...
            <div class="dropdown-menu dropdown-menu-animation dropdown-lg border-radius-xl p-3 mt-0 mt-lg-3" aria-labelledby="dropdownMenuAccount">
              <div class="row d-none d-lg-flex">
                <div class="col-6">
                  <div class="py-6 h-100 w-100 d-flex border-radius-lg position-relative dropdown-image" style="background-image:url('<%=request.getContextPath()%>/assets/img/curved-images/curved8.jpg')">
                  ...
                  <ul class="list-group">
                    <li class="nav-item dropdown dropdown-hover dropdown-subitem list-group-item border-0 p-0">
                      <a class="dropdown-item border-radius-md ps-3 d-flex align-items-center justify-content-between mb-1" id="dropdownSignIn">
                        <span>Sign In</span>
                        <img src="<%=request.getContextPath()%>/assets/img/down-arrow.svg" alt="down-arrow" class="arrow">
                      </a>
              ...
              <div class="d-none d-lg-block">
                <ul class="list-group">
                  <li class="nav-item list-group-item border-0 p-0">
                    <a class="dropdown-item py-2 ps-3 border-radius-md" href="<%=request.getContextPath()%>https://www.creative-tim.com/learning-lab/bootstrap/overview/soft-ui-dashboard">
                      <div class="d-flex">
                        <div class="icon h-10 me-3 d-flex mt-1">
                  ...
                  <li class="nav-item list-group-item border-0 p-0">
                    <a class="dropdown-item py-2 ps-3 border-radius-md" href="<%=request.getContextPath()%>https://www.creative-tim.com/learning-lab/bootstrap/colors/soft-ui-dashboard">
                      <div class="d-flex">
                        <div class="icon h-10 me-3 d-flex mt-1">
                  ...
                  <li class="nav-item list-group-item border-0 p-0">
                    <a class="dropdown-item py-2 ps-3 border-radius-md" href="<%=request.getContextPath()%>https://www.creative-tim.com/learning-lab/bootstrap/alerts/soft-ui-dashboard">
                      <div class="d-flex">
                        <div class="icon h-10 me-3 d-flex mt-1">
                  ...
                  <li class="nav-item list-group-item border-0 p-0">
                    <a class="dropdown-item py-2 ps-3 border-radius-md" href="<%=request.getContextPath()%>https://www.creative-tim.com/learning-lab/bootstrap/datepicker/soft-ui-dashboard">
                      <div class="d-flex">
                        <div class="icon h-10 me-3 d-flex mt-1">
                          <svg class="text-secondary" width="16px" height="16px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  ...
                  <li class="nav-item list-group-item border-0 p-0">
                    <a class="dropdown-item py-2 ps-3 border-radius-md" href="<%=request.getContextPath()%>https://www.creative-tim.com/learning-lab/bootstrap/utilities/soft-ui-dashboard">
                      <div class="d-flex">
                        <div class="icon h-10 me-3 d-flex mt-1">
                          <svg class="text-secondary" width="16px" height="16px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <ul class="navbar-nav d-lg-block d-none">
          <li class="nav-item">
            <a href="<%=request.getContextPath()%>https://www.creative-tim.com/product/soft-ui-dashboard-pro" class="btn btn-sm  bg-gradient-primary  btn-round mb-0 me-1" onclick="smoothToPricing('pricing-soft-ui')">Buy Now</a>
          </li>
        </ul>
      </div>
    </div>
          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form text-left" action="register" method="POST">
                ...
                <div class="mb-3">
                  <input type="password" name="cfmPass" class="form-control" placeholder="Confirm Password" aria-label="Confirm Password" aria-describedby="password-addon" required>
                </div>
                <div class="mb-3">
