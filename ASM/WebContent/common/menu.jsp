<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="<c:url value='/index'/>" target="_blank">
        <img src="<%=request.getContextPath()%>/assets/img/logo-ct.png" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">X-Video</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="<c:url value='/index'/>">
            ...
            <span class="nav-link-text ms-1">Libary</span>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link  " href="<c:url value='/favorites'/>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <div class="sidenav-footer mx-3 ">
      <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
        <div class="full-background" style="background-image: url('<%=request.getContextPath()%>/assets/img/curved-images/white-curved.jpeg')"></div>
